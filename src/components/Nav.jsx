...
import { LOGO_SRC } from "../utils/images.js";
    ...
    <header className="sticky top-0 z-50 backdrop-blur-md bg-paper/90 border-b border-navy/10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center" aria-label="Educa-Psy — accueil">
            <img src={LOGO_SRC} alt="Educa-Psy" className="h-9 w-auto" />
          </Link>
